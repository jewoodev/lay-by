...
> - 상품 등록
> - 장바구니(위시리스트)에 담기, 담은 상품 수량 조절, 제거
...
<img src="https://github.com/jewoodev/lay-by/blob/main/docs/erd.png?raw=true" alt="erd" width="80%" />

## 🚧 시스템 아키텍처

<img src="./docs/layby-architecture.png" alt="layby-architecture" width="80%" />
